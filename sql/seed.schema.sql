...
-- даты добавления,изменения,удаления учётных записей пользователей
...
--так же отдельно можно реализовать и часть про контролирующие органы и транспортные маршруты(отдельно от этих таблиц)
